...
def test_delete_request(request_id):
    ...
    newstatus=delete_requests_by_id(request_id)
    
    testreq=select_request_by_requestid(request_id)
   
    testreq_conditional= (testreq==None)

    assert testreq_conditional == True, "Delete request failed"